...
/** 模型/算法/场景子选项的启用状态 */
export type FeatureStatus = 'active' | 'placeholder'

export interface ModelAlgorithmState {
  currentStep: number
  selectedModel: string
  selectedAlgorithm: string
  /** 算法参数。NSGA-II 用 populationSize/iterationCount/crossoverRate；
   *  PAEM 额外加 kMut。其他字段（mutationRate/eliteRate/crowdingFactor）已废弃。 */
