 ...
 * 包含顶部控件（方案选择 + 导出）+ 两列布局：
 *   左列：目标满足情况
 *   右列（上下分区）：上→水量流向桑基图，下→过程曲线（水位/流量/出力切换）
 */
import { ref } from 'vue'
  ...
  <div class="decision-panel">
    ...
    <div class="decision-body">
      ...
      <div class="decision-col decision-col-right">
        <!-- 上半：水量流向桑基图 -->
        <div class="sub-chart-box sub-chart-top">
          <BaseChart ref="waterFlowBaseChart" :option="waterFlowOption" class="chart-container" />
        </div>
        <!-- 下半：过程曲线（带页签切换） -->
        <div class="sub-chart-box sub-chart-bottom">
          ...
          <BaseChart ref="processBaseChart" :option="processOption" class="chart-container" />
        </div>
      </div>
    </div>
  </div>
