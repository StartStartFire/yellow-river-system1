...
import ConstraintPanel, { type ConstraintGroup } from '@/components/model-config/model-algorithm/ConstraintPanel.vue'
...
const constraintValues = ref<ConstraintGroup>({
  initialWaterLevelLongyangxia: store.modelAlgorithm.initialWaterLevelLongyangxia,
  initialWaterLevelLiujiaxia: store.modelAlgorithm.initialWaterLevelLiujiaxia,
  icePreventionFlows: store.modelAlgorithm.icePreventionFlows,
})
