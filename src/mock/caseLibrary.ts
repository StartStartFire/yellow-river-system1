...
export const caseList = {
  ...
  data: [
    ...
    {
      id: 'case-2023-hybrid-001',
      title: '2023年上游水光互补优化调度案例',
      tag: '多能互补',
      tagColor: '#b37feb',
      iconType: 'hybrid',
      reservoirs: ['龙羊峡水库', '刘家峡水库'],
      caseType: ['多能互补', '水光互补'],
      createdAt: '2023-09-22 14:20:55',
      summary: '结合光伏出力特性，优化水库调度实现水光互补，提升清洁能源利用率。',
      status: '已验证',
      statusColor: '#00ff88',
      score: 91.8,
      cover: 'hybrid',
    ...
    {
      id: 'case-2021-flood-001',
      title: '2021年黄河上游秋汛防御调度案例',
      tag: '防洪调度',
      tagColor: '#ff4d4f',
      iconType: 'flood',
      reservoirs: ['龙羊峡水库', '刘家峡水库', '青铜峡水库'],
      caseType: ['实时', '防洪调度'],
      createdAt: '2021-10-08 11:33:27',
      summary: '2021年秋汛期间，通过精细调度成功应对连续洪水过程。',
      status: '已归档',
      statusColor: '#00afff',
      score: 93.5,
      cover: 'autumn-flood',
    ...
    {
      id: 'case-2024-eco-001',
      title: '2024年春季兴利调度保障案例',
      tag: '兴利调度',
      tagColor: '#00afff',
      iconType: 'eco',
      reservoirs: ['龙羊峡水库', '刘家峡水库', '公伯峡水库'],
      caseType: ['兴利调度'],
      createdAt: '2024-04-10 16:48:39',
      summary: '春季需水高峰期，优化水库调度保障下游用水需求，提升综合效益。',
      status: '待复核',
      statusColor: '#ffaa00',
      score: 87.1,
      cover: 'benefit',
